                    ...
                    <div class="tab-pane fade show active p-4 text-white" id="profitEstimatePane" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" id="numOfSharesInput" class="form-control" v-model="estimateProfit.numShares" placeholder="125" />
                            </div>
                            <div class="mb-3">
                                <label for="projectedPriceInput" class="form-label">Projected Price</label>
                                <input type="text" id="projectedPriceInput" class="form-control" v-model="estimateProfit.projectedPrice" placeholder="2.50" />
                            </div>
                            <div class="mt-4">
                                <p class="text-white">
                    ...
                    <div class="tab-pane fade p-4 text-white" id="sharesEstimatePane" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" id="amountToSpendInput" class="form-control" v-model="estimateShares.amountToSpend" placeholder="100" />
                            </div>
                            <div class="mb-3">
                                <label for="pricePerShareInput" class="form-label">Price per Share</label>
                                <input type="text" id="pricePerShareInput" class="form-control" v-model="estimateShares.pricePerShare" placeholder="2.50" />
                            </div>
